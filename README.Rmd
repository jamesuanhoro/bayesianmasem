...
[![minimal R version](https://img.shields.io/badge/R%3E%3D-`r bayesianmasem:::.minimum_r_version()`-6666ff.svg)](https://cran.r-project.org/)
...
specifically meta-analysis of confirmatory factor and path models.
...
- Handles missing correlations and variables in path analysis
models of correlation matrices.
